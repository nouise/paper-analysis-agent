...
class WeChatPublisher:
    ...
    def create_draft(self,
        ...
        # 只有当 thumb_media_id 不为空时才添加封面相关字段
        if thumb_media_id:
        ...
        print(f"  作者: {author}")
        print(f"  摘要: {digest}")
        print(f"  包含 thumb_media_id: {'thumb_media_id' in article_data}")
        if 'thumb_media_id' in article_data:
            print(f"  thumb_media_id 值: {article_data['thumb_media_id']}")
